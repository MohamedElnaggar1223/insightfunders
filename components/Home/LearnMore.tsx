...
{
    return (
        <section className='p-16 lg:p-24 flex items-center justify-between gap-16 bg-strong-gray max-md:flex-wrap'>
            <div className='flex flex-1 flex-col items-start justify-center text-left gap-12'>
                <div className='flex flex-col items-start justify-center text-left gap-6'>
                    <p className='text-white text-wrap font-semibold text-3xl lg:text-5xl lg:leading-[60px]'>Transparent relation between startups and investors.</p>
