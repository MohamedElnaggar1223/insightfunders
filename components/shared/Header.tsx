...
{
    return (
        <header className='flex justify-between text-sm lg:text-base items-center py-4 bg-black px-2 z-[9999999] lg:px-40 text-white gap-2 lg:gap-4 font-semibold absolute top-0 w-full'>
