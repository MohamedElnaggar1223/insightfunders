...
export default function SearchInvestorsBar() {
  ...
  return (
    <div className=" bg-white w-full flex items-center gap-4 py-2 px-5 rounded-[8px]">
      ...
      <form onSubmit={handleSubmit}>
        <input
          ...
          className="bg-transparent text-xs w-full h-full outline-none border-none"
        />
      </form>
      <Settings2
        size={28}
