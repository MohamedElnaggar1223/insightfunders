...
export default function StartupSideBarLinks() 
{
    ...
    return (
        <div className='flex flex-col w-full mt-8'>
            <Link href='/' className={cn('py-4 text-sm font-Montserrat w-full', (!pathname.startsWith('/offers') && !pathname.startsWith('/manage')) ? 'bg-white font-medium text-black' : 'text-white')}>Data Room</Link>
