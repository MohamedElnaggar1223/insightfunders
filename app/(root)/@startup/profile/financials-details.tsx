        ...
        <Table className='bg-white'>
            <TableHeader>
                <TableRow className=''>
                    ...
                    <TableHead className='p-6 border-2 text-center border-[#EAEAEA] font-Montserrat'>Equity</TableHead>
            ...
            <TableBody>
                ...
                <TableRow key={financialRound.id}>
                    <TableCell className="p-6 border-2 text-center border-[#EAEAEA] font-Montserrat">{financialRound.investor}</TableCell>
                    ...
                    <TableCell className="p-6 border-2 text-center border-[#EAEAEA] font-Montserrat">{financialRound.equity}</TableCell>
