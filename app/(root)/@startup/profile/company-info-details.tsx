...
export default function CompanyInfoDetails({ user, startUpOwners }: Props) {
  ...
  return edit ? (
                ...
                <FormControl>
                  ...
                  >
                    ...
                    {[
                      ...
                      <option value={businessStructure} key={businessStructure}>
                        {businessStructure}
                      </option>
                    ))}
                  </select>
                ...
                <FormControl>
                  ...
                  >
                    ...
                    {[
                      ...
                      <option value={industrySector} key={industrySector}>
                        {industrySector}
                      </option>
                    ))}
                  </select>
    ...
    <div className="flex flex-col gap-8">
      ...
      {startUpOwners.length > 0 && (
        <Tabs
          defaultValue={startUpOwners[0]?.id?.toString()!}
          className="flex flex-col gap-8"
        >
          <TabsList className="mr-auto">
            {startUpOwners.map((owner) => (
              <TabsTrigger
                className="!text-white text-sm data-[state=active]:!text-[#FF7A00] data-[state=active]:!bg-[#FF7A0014] w-[225px] h-10 border-b font-Montserrat font-semibold border-white data-[state=active]:border-[#FF7A00]"
                key={owner.id}
