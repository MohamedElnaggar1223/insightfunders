    ...
    return (
        <section className='flex w-full flex-col gap-4 mt-12'>
            <div className='flex items-center justify-between gap-4'>
                <p className='font-bold dashboardtablehead   text-black text-xl'>Pitch Deck</p>
                <UploadPitchDeck />
            </div>
            <Table className='bg-white'>
                ...
                <TableBody>
                    ...
                    <TableRow key={PitchDeck.id}>
                        ...
                        <TableCell className="px-1 border-2 text-center border-[#EAEAEA]  chartcontenttext ">{PitchDeck.name}</TableCell>
                        <TableCell className="px-1 border-2 text-center border-[#EAEAEA]   chartcontenttext">{formatDate(new Date(PitchDeck?.created_at!))}</TableCell>
                        <TableCell className="px-1 border-2 text-center border-[#EAEAEA]  chartcontenttext ">{formatDate(new Date(PitchDeck?.updated_at!))}</TableCell>
