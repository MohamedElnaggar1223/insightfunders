...
export default async function HeaderStartUp() {
  ...
  return (
    <div className="ml-auto flex  items-center justify-end h-fit px-12 py-6 bg-[#fff] w-full gap-3 shadow-lg navbarmobilemenu">
      ...
      <Link href="/profile" className="flex items-center justify-center gap-3">
        ...
        <p className="text-black font-light text-sm userName">
