            ...
            <div className="flex flex-col items-center justify-between gap-12">
                ...
                <div className="flex flex-col items-center justify-center gap-8">
                    <div className="flex flex-col items-center justify-center gap-4">
                        ...
                        <h3 className='font-light max-lg:text-xs text-base text-center max-w-[751px]'>Leverage Insight Funders' Credit Markets to secure a tailored capital solution. Access fast, flexible credit with a seamless application process through our integrated lender network.</h3>
                    </div>
