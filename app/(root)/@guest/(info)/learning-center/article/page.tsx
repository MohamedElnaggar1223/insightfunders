    ...
    return (
        <section className='flex flex-col flex-1 items-start text-left gap-4'>
            <div className='flex flex-col gap-12 pt-8 text-black text-center w-full items-center justify-center'>
                <div className="flex flex-col gap-6 py-4 w-full max-w-[788px] bg-[#111111E5] text-white h-[226px] items-center justify-center">
                    ...
                    <div className='flex flex-col gap-4 items-center justify-center'>
                        <input type='email' placeholder='Email' className='flex flex-1 px-6 placeholder:font-light py-3.5 text-sm rounded-[2px] outline-none max-w-[283px] h-[49px]' />
                        <button className='bg-[#FF7A00] text-white font-bold rounded-[2px] py-3.5 text-sm px-4 max-w-[283px] w-full disabled:opacity-70 h-[49px]'>Subscribe</button>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center gap-8 py-8">
                <p className='text-sm text-left'>Simialr articles</p>
